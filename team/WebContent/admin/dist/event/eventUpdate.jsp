	                        ...
	                        <div class="card mb-4 ecol-12 ecol-lg-8 ecol-xl-9">
	                            ...
	                            <div class="card-body">
	                                <div class="table-responsive">
		                                <form action="${contextPath}/eventAdmin/updateEvent.do" method="post" enctype="multipart/form-data" class="writeForm">
		                                    ...
		                                    <table class="table table-bordered" width="100%" cellspacing="0">
		                                        ...
		                                        <tbody>
		                                        	<tr align="center"><th colspan="2" >이벤트 수정</th></tr>
		                                        	<tr>
														<th>제목</th>
														<td>
													...
													<tr>
														<th>내용</th>
														<td>
															<textarea cols="40" rows="15" name="eventContent">${eventContent}</textarea>
														</td>
													</tr>
													<tr>
														<th>첨부파일</th>
														<td>
															<c:if test="${not empty eventImage}">
																...
																<p class="alert">파일 첨부 시 기존 파일이 삭제됩니다.</p>
															</c:if>
															<input type="file" name="eventImage" id="eventImage" onchange="checkFile(this); showPreview(this, 'image');">
														</td>
													</tr>
		                                        </tbody>
		                                    </table>
	                            ...
	                            <div class="card-body">
	                                <div class="table-responsive">
	                                    <table class="table table-bordered" width="100%" cellspacing="0">
	                                        ...
	                                        <tbody>
	                                        	<tr>
	                                        		<td><img src="${contextPath}/files/event/${eventNo}/${eventImage}" id="thumbnail" class="maxwid"></td>
	                                        	</tr>
	                                        </tbody>
	                                    </table>
	                                </div>
